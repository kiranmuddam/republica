...
<body>
    ...
    <div class="jumbotron  text-center ">
        <br><a href="#" >&nbsp;<span class="font-big color-red"> <?php echo $title;?></span></a><br>
        SDCAC would like to organize REPUBLICA 2K18, Republic
Day Celebrations. As a part of this, SDCAC is going to conduct
Grand Quiz competition.<br><br>
<b><u>Topics for prelims round:</u></b>
	General knowledge, current affairs<br><br>
 
<b><u>Rules:</u></b><br>
Open to all. (Separate for PUC and engineering)<br>
Group event (group is strictly confined to 3 members)<br>
Each group must bring one laptop, lan cable. (jar file)<br>
Mobile phones are not allowed.<br>
Late comers are not entertained.<br>
...
<a onclick="shw('junior')" style="cursor:pointer;text-decoration:none;padding:10px;border-radius:15px;width:300px;background:green;">Registered Teams(PUC)</a>
<a onclick="shw('senior')" style="cursor:pointer;text-decoration:none;padding:10px;border-radius:15px;width:300px;background:green;">Registered Teams(ENGG)</a>
                  <br><br>
            <div id="junior" style="height:217px;display:none;word-wrap:break-word;width:550px;overflow-x:hidden;">
                 <?php
//teams
     echo "<center>";
	$kt=mysql_query("SELECT * FROM users WHERE eid='quiz' and (ids LIKE 'N16%' || ids LIKE 'N17%' || ids LIKE 'S16%' || ids LIKE 'S17%')") or die(mysql_error());
...
<div id="front" style="height:217px;word-wrap:break-word;width:550px;overflow-x:hidden;">
	<center>
		<table width="100%" border="1">
			...
			<tr><td style="width:50%;background:#006666;color:#fff;font-weight:bold;"><h5>Registered Teams(P1-P2)</h5></td>
<td style="padding-left:30px;"><h4><?php echo $jun;?></h4></td>
			</tr>
			<tr><td style="width:50%;background:#ee6666;color:#fff;font-weight:bold;"><h5>Registered Teams(E1-E2-E3-E4)</h5></td>
<td style="padding-left:30px;"><h4><?php echo $sen;?></h4></td>
			</tr>
