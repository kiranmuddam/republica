...
<body>
    ...
    <div class="jumbotron  text-center ">
        <br><a href="#" >&nbsp;<span class="font-big color-red"> <?php echo $title;?></span></a><br><br><b> Engineering Topic : </b> - <big><b><u>Gender Stereotypes in India</u></b></big><br><br><b> PUC Topic : </b> - <big><b><u>Are Nuclear weapons a necessity for a country in the modern world?</u></b></big><br><br><i>*Paper will be provided at venue.</i>
    </div>
    <!--End jumbotron-->
    <div class="container">
...
//teams
     echo "<center>";
	$kt=mysql_query("SELECT * FROM users WHERE eid='essay' and (ids LIKE 'N16%' || ids LIKE 'N17%' || ids LIKE 'S16%' || ids LIKE 'S17%')") or die(mysql_error());
...
//teams
     echo "<center>";
	$kt=mysql_query("SELECT * FROM users WHERE eid='essay' and (ids LIKE 'N12%' || ids LIKE 'N13%' || ids LIKE 'N14%' || ids LIKE 'N15%')") or die(mysql_error());
	echo "<table border=1 cellpadding='30' style='text-align:center;'><tr>";
    $sen=0;
	if(mysql_num_rows($kt)>0)
	{
