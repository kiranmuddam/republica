...
<body>
    ...
    <!--jumbotron-->
    <div class="jumbotron  ">
        <br><center><a href="#" >&nbsp;<span class="font-big color-red"> <?php echo $title;?></span></a></center>
        <br><br>
        To all the Enthusiastic NewsReaders there<br>
        1)Are you vexed of current news.<br>
        2)Do you wish to see a newspaper that resembles that as in your fantasy world?<br>
           And the wait is over<br>
           Here is an great oppurtunity for every voracious newsreaders,inquistive learners,RGUKT's one of the best innovative event titled"TABLOID"-The newspaper you wish to see.<br><br>
           <b><u>Instructions:</u></b>
           1)Design a newspaper of A4 sheets of columns include National,International,Sports,Movies,Science and Technology,etc. that You wish to see that either in future or present. <br>
           2)The teamsize must be from 1-4.<br>
           3)Submit your newspaper on 25th january from 5pm to 7pm @I3 F65.<br>
           4)Medium of language:English or Telugu.<br><br>
           ***So,dive into your creative world and add a tinge of innovation to your thoughts***
    </div>
    <!--End jumbotron-->
    <div class="container">
